...
**DO** use State Model format for concept examples — Properties, Operations, Module — not CRC class-responsibility-card format (no "Get X: Type, Collaborator" style). See `core.md` State Concept and `output/state-model-output.md`.
...
**DO NOT** use CRC format (responsibilities + collaborators) for State Model examples. Use State Concept format: Name, Module, Properties, Operations.
