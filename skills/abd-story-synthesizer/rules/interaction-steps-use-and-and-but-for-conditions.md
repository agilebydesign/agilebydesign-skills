...
Use **And** for multiple system reactions to one event; use **But** for negative conditions and constraints. Applies to Trigger/Response and steps. (Merges use_and_for_multiple_reactions and use_but_for_negative_conditions.)
