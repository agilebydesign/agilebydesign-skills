...
Any node (epic, story, scenario) has approximately 4–9 children. Does not apply to steps. For stories, count **steps** as children (not scenarios). (Adapted from stories_have_4_to_9_acceptance_criteria.)
